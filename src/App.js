    ...
    return (
        <div className="demo-big-content">
            <Layout className="mdl-layout mdl-js-layout mdl-layout--fixed-header" style={{}}>
                <Header style={{width: '95%', marginLeft:'auto', marginRight:'auto', marginTop: '1%'}} className="header-color" title={< Link style={{textDecoration:'none', color:'white', fontFamily: "'Roboto', 'Helvetica', 'Arial', sans-serif", fontWeight: 'bold'}} to ="/portfolio2">
